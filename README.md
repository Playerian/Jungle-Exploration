...
Developer's Hut: First, add a button and related varible in function DevHutMenu. Then do anything you want in that button. Remember to diffrentiate it with other buttons.
# FAQS:
